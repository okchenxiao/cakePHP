...
class UeditorComponent extends Component{
    ...
    public function initialize(Controller $controller) {
        ...
        $this->component_dir = __DIR__.DS.'Ueditor'.DS;

        $config_file = $this->component_dir.'config.json';
    ...
    public function uploadimage(){
        ...
        switch (htmlspecialchars($_GET['action'])) {
            ...
            case 'uploadscrawl':
                $config = array(
                    ...
                    "allowFiles" => $COthis->config['scrawlAllowFiles'],
                    "oriName" => "scrawl.png"
                );
        ...
        /* 生成上传实例对象并完成上传 */
        $up = new UploaderFile($fieldName, $config, $base64);
    ...
    public function catchimage(){
        ...
        foreach ($source as $imgUrl) {
            $item = new UploaderFile($imgUrl, $config, "remote");
