...
var App = function () {
    ...
    var handleSidebarMenu = function () {
        jQuery('.page-sidebar').on('click.menu', 'li > a', function (e) {
...
$(function(){
    ...
    if (dname !== undefined) {
        $("li.menu"+menuname+">ul.sub-menu>li:eq("+cname+")>a>span.arrow").addClass("open");
        $("li.menu"+menuname+">ul.sub-menu>li:eq("+cname+")").addClass("open");
        $("li.menu"+menuname+">ul.sub-menu>li:eq("+cname+")>ul.sub-menu").show();
...
function setmenus(data,res,ces){
    $.session.set('key', data);
    $.session.set('ckey', res);
    $.session.set('dkey', ces);
}
